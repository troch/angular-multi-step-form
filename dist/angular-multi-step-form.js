...
.factory('formStepElement', [
    ...
    '$q',
    '$templateCache',
    function ($compile, $controller, $http, $injector, $q, $templateCache) {
        /**
    ...
    function () {
        return function FormStep (config) {
            if (!config.template && !config.templateUrl) {
                throw new Error('Either template or templateUrl properties have to be provided for' +
                    ' multi step form' + config.title);
            }
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('multi-step-form/partials/multi-step-container.html',
    '<section class=multi-step-container><header class=multi-step-header multi-step-header></header><article class=multi-step-body form-step-container></article></section>');
}]);
})();
